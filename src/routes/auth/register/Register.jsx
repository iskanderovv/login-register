    ...
    <div className="flex justify-center items-center h-screen">
      <div className="max-w-[350px] w-full text-center">
        ...
        <form action="#" className="flex flex-col gap-4 my-8 w-full">
          <input className="text-[#333] border-2 border-cyan-500 py-2 px-2 outline-none rounded-md text-[18px] tracking-wide focus:border-green-500" type="text" placeholder='Name' />
          ...
          <input className="text-[#333] border-2 border-cyan-500 py-2 px-2 outline-none rounded-md text-[18px] tracking-wide focus:border-green-500" type="url" placeholder='Image' />
